...
Show intentions and quick-fixes Alt + Enter
...
- GENERAL
```
Open corresponding tool window Alt + 0 ... Alt + 9
Save all Ctrl + S
...
Select next / all occurrences Alt + J / Ctrl + Alt + Shift + J
Unselect occurrence Alt + Shift + J

- DEBUGGING
Step into / Smart step into F7 / Shift + F7
Step over / out F8 / Shift + F8
...
Brief info Ctrl + Моuse hover
Show descriptions of error at caret Ctrl + F1
Override / implement methods Ctrl + O / Ctrl + I
...
Go to super-method or super-type Ctrl + U
Go to previous / next declaration Alt + Up / Down
...
Go to numbered bookmark Ctrl + 0 ... Ctrl + 9
